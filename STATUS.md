...
| 02-23 | V3.5.4 | Kliento matomumas ir veiksmai: `backend/docs/KLIENTO_MATOMUMAS_IR_VEIKSMAI.md` — aprašytas kliento portalo turinys, veiksmai ir susiejimas su admin (kliento kortelė, planuotojas, projekto diena). Admin kliento kortelė: Figma pritaikymas — header, „Kas dabar?“ blokas, „Procesas ir būsena“ (timeline), modal su simbolių skaičiumi; JS „Kas dabar?“ + visi veiksmai lietuviškai. |
